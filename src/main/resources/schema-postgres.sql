...
CREATE TABLE feedbacks(feedback_id serial PRIMARY KEY,user_id int,FOREIGN KEY (user_id) REFERENCES users(user_id),hotel_id int,FOREIGN KEY (hotel_id) REFERENCES hotels(hotel_id),rating float, review VARCHAR(100));